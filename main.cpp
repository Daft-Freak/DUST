...
static const std::array display_object_tests {
    ...
    test_info {"Display/Objects reg 8b hflip", display_obj_regular_8bpp_hflip},
    test_info {"Display/Objects reg 8b vflip", display_obj_regular_8bpp_vflip},
    test_info {"Display/Objects reg 8b hvflip", display_obj_regular_8bpp_hvflip},
    test_info {"Display/Objects aff rotscale", display_obj_affine_rotscale},
    test_info {"Display/Objects aff 8b rtscl", display_obj_affine_8bpp_rotscale},
...
static const std::array display_window_tests {
    ...
    test_info {"Display/Window obj win mx bg", display_window_obj_win_mixed_bg},
    test_info {"Display/Window priority", display_window_priority},
    test_info {"Display/Window objects", display_window_objects},
    test_info {"Display/Window objects mix", display_window_objects_mixed},
...
static const std::array display_mosaic_tests {
    ...
    test_info {"Display/Mosaic mode 3 4x4", display_mosaic_mode3_4_4},
    ...
    test_info {"Display/Mosaic mode 4 4x4", display_mosaic_mode4_4_4},
    ...
    test_info {"Display/Mosaic mode 5 4x4", display_mosaic_mode5_4_4},
